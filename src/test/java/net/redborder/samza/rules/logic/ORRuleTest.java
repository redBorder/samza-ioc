...
public class ORRuleTest extends TestCase {
    ...
    public void allEnableRule() {
        ...
        ORRule orRule = new ORRule("OR", rules);
        ...
        assertTrue(orRule.verify("AABBCCDD", message));
    }
    ...
    public void allDisableRule() {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put("field2", "value2co1fi1m1d");
        message.put("field4", "value4");
        message.put("otherField1", "otherValue1");
        message.put("otherField2", "otherValue2");

        assertFalse(orRule.verify("AABBCCDD", message));
    }
    ...
    public void notEnableAndDisableRule() {
        ...
        assertNull(orRule.verify("AABBCCDD", message));
    }
    ...
    public void enableAndDisablerule() {
        ...
        messageEnable.put("field1", "valueX");
        ...
        assertTrue(orRule.verify("AABBCCDD", messageEnable));
        ...
        assertFalse(orRule.verify("AABBCCDD", messageDisable));
    }
}
